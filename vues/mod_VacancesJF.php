            ...
            <div class="col-lg-7">
                <table class="table table-bordered">
                    ...
                    for ($i = 0; $i < count($tabVacances); $i++) {
                        ...
                        <button type="submit" name="annuler" class="btn btn-success" class="glyphicon glyphicon-ban-circle"><span
                                class="glyphicon glyphicon-ban-circle"></span> Annuler</button>
                        <button type="submit" name="updateVac" class="btn btn-warning"><span
                                class="glyphicon glyphicon-floppy-open"></span> Enregistrer</button>
                    </form>
                </table>
            </div>
        </div>
