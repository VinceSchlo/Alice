        ...
        <form class="form-horizontal" action="add_Agent.php" method="POST">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input size="20" id="nom" name="nomForm" placeholder="Nom" class="form-control input-md"
                               required="" type="text">
                    </div>
                </div>
                <!-- Prénom de l'agent-->
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input size="20" id="prenom" name="prenomForm" placeholder="Prénom"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4" id="divMdp2" style='display:none;'>
                        <input size="20" type="password" id="mdp2" name="mdp2Form"
                               placeholder="Confirmez le mot de passe" class="form-control input-md">
                    </div>
                </div>
                <!-- Button (Double) -->
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        ...
                        <button name="insertAgent" class="btn btn-warning" onclick="return verif2MdpForm()"><span class="glyphicon glyphicon-floppy-open"
                                                                                ></span>
                            Enregistrer
                        </button>
                    </div>
